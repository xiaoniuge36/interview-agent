import { BatchCandidateReviewResultSchema, ImportReviewContextSchema } from '@interview-agent/contracts';
...
describe('import review context requests', () => {
  it('uses the task-scoped source context endpoint', () => {
    const request = (trainingContentApi as unknown as ReviewContextRequestFactory)
...
describe('batch candidate review requests', () => {
  it('sends a validated PATCH request to the batch review endpoint', () => {
    const createRequest = (trainingContentApi as unknown as {
