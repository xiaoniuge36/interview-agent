...
export const MARKET_COMMERCIAL_ROLE_TEMPLATES: RoleTemplate[] = [
  defineRole({
    ...
    title: '市场营销经理',
    jdText:
      '负责市场策略、整合传播和活动运营，结合目标人群与渠道资源提升品牌认知、线索质量和业务影响。',
    companyContext:
      '业务需要在竞争加剧的市场中建立清晰心智，团队希望将传播动作与获客和转化结果连接起来。',
    communicationText:
      '讲清市场问题、受众洞察、渠道组合、资源取舍和效果复盘，体现策略与执行的连贯性。',
  ...
  defineRole({
    ...
    communicationText:
      '说明定位如何形成、创意如何服务策略、不同渠道如何协同，以及如何评估长期品牌效果。',
  ...
  defineRole({
    ...
    title: '销售经理',
    jdText:
      '负责客户开发、商机推进和团队协同，通过清晰的销售策略、客户洞察和过程管理达成营收目标。',
    companyContext:
      '销售周期较长且客户决策角色复杂，团队需要提升重点行业突破能力和可预测的成交效率。',
    communicationText:
      '用真实商机说明客户识别、需求挖掘、异议处理、内部协同与结果复盘，避免只报业绩数字。',
  ...
  defineRole({
    ...
    communicationText:
      '说明目标伙伴筛选、合作方案、利益平衡、风险判断和合作效果，不把签约当作唯一终点。',
  ...
  defineRole({
    ...
    companyContext:
      '客户规模扩大后，团队需要更主动地识别风险、提升活跃和续约，并建立规模化服务机制。',
    communicationText:
      '结合客户案例说明目标对齐、价值证明、风险预警、跨部门推动和最终续约或增购结果。',
