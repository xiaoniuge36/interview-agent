...
function QuestionCatalogCard({
  ...
  return (
    ...
    >
      <button
        className="question-select-control"
        type="button"
        onClick={onToggle}
...
function QuestionListLoading() {
  return (
    <div className="question-list-state">
      <strong>正在整理题库</strong>
      <p>筛选结果马上就好。</p>
    </div>
  );
}
